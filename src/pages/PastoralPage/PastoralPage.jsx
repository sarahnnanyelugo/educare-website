        ...
        <center>
          <div className="col-md-5">
            ...
            <p>
              ...
              With educare Pastoral platform, unlock the potential to shape
              future leaders, nurture personal growth, and create an atmosphere
              where students thrive, ultimately setting the stage for a brighter
          ...
          <div className="col-md-4">
            <div className="col-md-10">
              <Efficiency
                ...
                icon={Track}
                paragraph="Every student is unique, and so should be their well-being tracking. educare Pastoral platform offers customizable tools that adapt to such unique vision and goals. With our pastoral platform, you hold the power to tailor student support, ensuring a holistic approach that fosters a thriving and resilient student community."
              />
            </div>
          </div>{" "}
          <div className="col-md-4">
            <div className="col-md-10">
              <Efficiency
                title="Data is Power"
                icon={Storage}
                subtitle="Centralized Data Storage with educare Pastoral platform!"
                paragraph="In the quest for student well-being, data is the driving force. With educare Pastoral platform's centralized data storage, access and analysis become effortless. Retrieve critical information about individual students and analyze trends at a macro level. Armed with this powerful information, your pastoral team can make informed decisions, identify areas of improvement, and implement targeted interventions to nurture students' emotional and academic growth."
              />
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="col-md-11">
            <Efficiency
              ...
              icon={Together}
              subtitle="Collaborative Communication with educare Pastoral platform!"
