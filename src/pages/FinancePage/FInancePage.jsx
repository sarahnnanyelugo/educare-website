    ...
    <>
      ...
      <center>
        ...
        <div className="col-md-6 finance-intro">
          ...
          />
          <h1>
            Simplify your Business with educare Powerful Finance platform.
          </h1>
      ...
      <div id="features" />
      <center>
        <h1 className="col-md-5">Key Features of educare Finance platform</h1>
      </center>
      <DashboardDisplay />
          ...
          <div className="col-md-4">
            <div className="col-md-10">
              <Efficiency
                ...
                icon={Setting}
                paragraph="By simplifying and automating essential financial processes, educare finance platform  optimizes your business operations such as purchase and inventory management, order tracking, and fulfillment. It maximizes sales potential by providing more selling channels while efficiently managing multiple warehouses, thereby improving order processing time and enhancing customer satisfaction."
              />
            </div>
          </div>{" "}
          <div className="col-md-4">
